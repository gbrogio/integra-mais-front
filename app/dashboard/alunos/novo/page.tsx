...
export default function NovoAlunoPage() {
  ...
  console.log("[v0] NovoAlunoPage renderizando")

  useEffect(() => {
    const loadPlanos = async () => {
      try {
        console.log("[v0] Carregando planos...")
        const data = await api.getPlanos()
        console.log("[v0] Planos carregados:", data)
        setPlanos(data)
      } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log("[v0] Criando aluno com dados:", formData)
      ...
      console.log("[v0] Aluno criado com sucesso")
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-slate-400">Cadastre um novo aluno no sistema</p>
        </div>
      </div>
